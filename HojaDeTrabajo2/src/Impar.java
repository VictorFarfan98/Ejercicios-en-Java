 ...
 * @author vafm9
 */
public class Impar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listado de impares");
    ...
    private void enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarActionPerformed
        ...
        if(FuncionesImpar.validartabla(n)==true){
            System.out.println("numero validado");
            for (int i = 1; i <= n; i++) {
                if(FuncionesImpar.impar(i)==true){
